...
THREADING
when multithreading CPU heavy tasks, since only one thread is executed at any given time,
it will be like serial execution PLUS the time spent to switch between the threads.
'''
