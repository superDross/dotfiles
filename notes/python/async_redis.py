"""
A pretend chat application to demonstrate how to utilise Redis asynchronously.
"""
...
class Chat:
    ...
    async def get_name(self):
        """
        Return name of the chat room from redis store.
        """
...
async def main():
    ...
    click.secho(" Chat ", fg="cyan", bold=True, bg="yellow")
